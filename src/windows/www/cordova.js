...
; (function () {
    ...
    define("cordova/exec", function (require, exports, module) {
        ...
        module.exports = function (success, fail, service, action, args) {
            ...
            // TODO: The original WP8 implementation had some special handling for passing Buffers
            // I am not sure if this is handled correctly by JSON.stringify
            ...
            try {
                if (window.external) {
                    ...
                    console.log("window.external not available :: payload=" + payload);
                }
            }
            catch (e) {
                console.log("Exception calling native with payload :: " + payload + " :: exception=" + e);
            }
        };
    ...
    define("cordova/exec/proxy", function (require, exports, module) {
        module.exports = {
            add: function (id, proxyObj) { return proxyObj; },

            remove: function (id) { return null; },

            get: function (service, action) { return null; }
        };
    });
    ...
    define("cordova/pluginloader", function (require, exports, module) {
        ...
        function injectIfNecessary(id, url, onload, onerror) {
            ...
            if (id in define.moduleMap) {
                onload();
            } else if (url.indexOf('/src/windows/') === -1) {
                ...
                define(id, function (require, exports, module) { module.exports = {}; });
                onload();
            }
        }
